...
@dataclass
class DirectionalHeatmapBuilder:
    ...
    def with_height(self, height: int) -> "DirectionalHeatmapBuilder":
        self.height = height
        return self

    def with_width(self, width: int) -> "DirectionalHeatmapBuilder":
        self.width = width
        return self

    def with_frames(self, frames_count: int) -> "DirectionalHeatmapBuilder":
        self.frames_count = frames_count
        return self

    def with_fps(self, fps: int) -> "DirectionalHeatmapBuilder":
        self.fps = fps
        return self
    ...
    def with_max_lost_frames(self, max_lost_frames: int) -> "DirectionalHeatmapBuilder":
    ...
    def build(self) -> "DirectionalHeatmap":
        ...
        return DirectionalHeatmap(self)
